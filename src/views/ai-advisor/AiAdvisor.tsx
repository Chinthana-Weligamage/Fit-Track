  ...
  return (
    <div className="flex flex-col w-full max-w-2xl h-[80vh] mx-auto my-10 border border-zinc-600 rounded-2xl shadow-lg overflow-hidden">
      ...
      <div className="bg-amber-300 text-center py-4 border-b">
        <p className="text-lg font-semibold text-black">AI Advisor</p>
      </div>
          ...
          >
            <div
              className={`px-4 py-2 rounded-lg  ${
                msg.sender === "user"
                  ? "bg-amber-300 text-black rounded-br-none max-w-xs"
                  : "bg-zinc-300 text-black rounded-bl-none max-w-xl"
              }`}
            >
